...
def run_wavelet(inputpath, outputpath, flight, file_name, scale, sigma_factor):
    ...
    # Read and covert the original 10m NetCDF to a GeoTIFF file
    ...
    ### Ethan: i dont think pod needs and throws shape error..
...
if __name__ == "__main__":
    ...
    parser.add_argument("inputpath", nargs='?', type=str, default='/n/holylfs04/LABS/wofsy_lab/Lab/zzhang/', 
                    help="Input path to the NetCDF files.")
    parser.add_argument("outputpath", nargs='?', type=str, default='/n/holylfs04/LABS/wofsy_lab/Lab/zzhang/', 
