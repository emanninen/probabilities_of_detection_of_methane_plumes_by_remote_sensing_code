...
#SBATCH -o /n/home00/emanninen/phd/emiss_dist/scripts/pod/sim_cont_rel/out_cont_rel.txt  
#
echo 'slurm job id:' $SLURM_JOB_ID
echo 'slurm job name:' $SLURM_JOB_NAME

cont_rel_dir="/n/home00/emanninen/phd/emiss_dist/scripts/pod/sim_cont_rel/"
